...
/** Adds a token. What exactly is a token? What is the purpose of a token? 
 * For now, there are these things called tokens. I don't know why they exist or what 
 * they do, but this function's job is to add one.
 * @param token: string pointer for something called a token.
 */
...
/** Parses the command code from a previously-parsed SCPI command. Uses these things called "tokens"
 * which I cannot make heads or tails of. Not clear what they actually mean. What on earth is a token?
 */
...
/** Sets the command tree to base. What does that mean? */
...
/** Sets the command tree to base with a constant character. Not sure what this does either */
